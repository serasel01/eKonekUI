...
public class StaMariaIndigent extends Certificate{
    private final String template = "src/main/resources/certificates/StaMaria/CERTIFICATE-OF-INDIGENCY.docx";

    public StaMariaIndigent(String name,
                            String address,
                            String civilStatus,
                            String sex,
                            int age,
