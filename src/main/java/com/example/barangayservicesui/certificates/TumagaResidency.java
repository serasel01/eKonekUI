...
public class TumagaResidency extends Certificate{
    private final String template = "src/main/resources/certificates/Tumaga/CERTIFICATE-OF-RESIDENCY.docx";

    public TumagaResidency(String name,
                           String address,
                           String civilStatus,
                           String sex,
                           int age,
