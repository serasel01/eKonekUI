...
public class TumagaClearance extends Certificate{
    private final String template = "src/main/resources/certificates/Tumaga/BARANGAY-CLEARANCE.docx";


    public TumagaClearance(String name,
                           String address,
                           String civilStatus,
                           String sex,
                           int age,
