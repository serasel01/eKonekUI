...
public class TetuanCertification extends Certificate {
    private final String template = "src/main/resources/certificates/Tetuan/BARANGAY-CERTIFICATE.docx";

    public TetuanCertification(String name,
                               String address,
                               String civilStatus,
                               String sex,
                               int age,
    ...
    public void saveCertificate(Document document) throws IOException {
        String fileName = "src/main/resources/CreatedCertificates/" +
                getName() + "-TetuanCertification.doc";
