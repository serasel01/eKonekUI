...
public class StaMariaGoodMoral extends Certificate{
    private final String template = "src/main/resources/certificates/StaMaria/CERTIFICATE-OF-GOODMORAL.docx";

    public StaMariaGoodMoral(String name,
                             String address,
                             String civilStatus,
                             String sex,
                             int age,
