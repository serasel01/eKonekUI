...
public class TetuanResidency extends Certificate{
    private final String template = "src/main/resources/certificates/Tetuan/CERTIFICATE-OF-RESIDENCY.docx";

    public TetuanResidency(String name,
                           String address,
                           String civilStatus,
                           String sex,
                           int age,
