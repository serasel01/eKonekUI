...
public class GuiwanCertification extends Certificate{
    private final String template = "src/main/resources/certificates/Guiwan/BARANGAY-CERTIFICATE.docx";

    public GuiwanCertification(String name,
                               String address,
                               String civilStatus,
                               String sex,
                               int age,
    ...
    public void saveCertificate(Document document) throws IOException {
        String fileName = "src/main/resources/CreatedCertificates/" +
                getName() + "-GuiwanCertification.doc";
